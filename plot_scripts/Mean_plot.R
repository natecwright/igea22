...
saveRDS(ep_late_df, 'C:/Users/Stella/OneDrive - University of Massachusetts/Documents/IGEA/Munge/igea22/outputs/ep_late.rds')
tp_late_df=do.call(rbind, lapply(tp_late, readRDS))
saveRDS(tp_late_df, 'C:/Users/Stella/OneDrive - University of Massachusetts/Documents/IGEA/Munge/igea22/outputs/tp_late.rds')
...
saveRDS(ep_early_df, 'C:/Users/Stella/OneDrive - University of Massachusetts/Documents/IGEA/Munge/igea22/outputs/ep_early.rds')
tp_early_df=do.call(rbind, lapply(tp_early, readRDS))
saveRDS(tp_early_df, 'C:/Users/Stella/OneDrive - University of Massachusetts/Documents/IGEA/Munge/igea22/outputs/tp_early.rds')
